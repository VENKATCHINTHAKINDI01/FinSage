...
run "Ruff lint"                     python3 -m ruff check backend/core backend/evals backend/llm backend/middleware backend/rag/embeddings.py backend/tools/calculation.py \
  ...
  backend/tests/test_context_and_parallel.py backend/tests/test_websocket_auth.py backend/services/parsers scripts --output-format=concise
